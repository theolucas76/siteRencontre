...
$loversHomme = [
   ...
   ['lastname' => 'Haba', 'firstname' => 'Bart', 'age' => '25', 'gender' => 'Homme', 'email' => 'barthaba@hotmail.fr', 'zipcode' => '76600', 'picture' => 'ppb3.png', 'description' => 'J\'ai 25 ans j\'habite au Havre et je possède un bar tabac'],
     ...
     ['lastname' => 'Gole', 'firstname' => 'Henri', 'age' => '32', 'gender' => 'Homme', 'email' => 'henrigole@hotmail.fr', 'zipcode' => '76600', 'picture' => 'ppb5.png', 'description' => 'Je me présente je m\'appelle Henri, j\'aime beaucoup rigoler'],
...
$loversFemme = [
     ['lastname' => 'Zeublouse', 'firstname' => 'Agathe', 'age' => '24', 'gender' => 'Femme', 'email' => 'agathezeublouse@hotmail.fr', 'zipcode' => '76600', 'picture' => 'ppg1.png', 'description' => 'Fan de musique, j\'aime plusieurs styles mais le blues me suivra toute ma  vie'],
     ['lastname' => 'Kepoura', 'firstname' => 'Adrienne', 'age' => '30', 'gender' => 'Femme', 'email' => 'adriennekepoura@hotmail.fr', 'zipcode' => '76600', 'picture' => 'ppg2.png', 'description' => 'Je suis une femme sans pression, je vis au jours le jour'],
     ...
     ['lastname' => 'Arepassé', 'firstname' => 'Jennifer', 'age' => '29', 'gender' => 'Femme', 'email' => 'jenniferarepassé@hotmail.fr', 'zipcode' => '76600', 'picture' => 'ppg6.png', 'description' => 'Si je me fais froiser, je vais repasser'],
...
?>
          ...
          <?php } ?>
          <!----------------------------------------------------modal---------------------------------------------------------------------->
          <div class="modal fade" id="<?= $firstname ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <a class=" btn text-white btnCustom" data-bs-dismiss="modal">x</a>
                         <div class="p-5 border border-white">
                              ...
                              <div class="d-flex justify-content-end mt-2">
                                   <span id="btnLike" class="btn btn-outline-light btnCustom mx-auto">Like ♡</span>
                              </div>
                         </div>
                    </div>
               </div>
     ...
     foreach ($loversHomme as $key => $infos) {
          ...
          <div class="modal fade" id="<?= $firstname ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
               <div class="modal-dialog text-white" role="document">
                    ...
                    <div class="modal-content d-flex justify-content-center text-center p-5" id="gradient-bg">
                         <a class="justify-content-end btn text-white btnCustom" data-bs-dismiss="modal">x</a>
                         <div class="p-5 border border-white">
                              <div class="row">
                                   <div class="col-md-12">
                                        <img src="../assets/img/<?= $photo ?>" class="d-block img-fluid w-100">
